...
class DataDiscoveryAgent:
    ...
    def __init__(self, model_id: str = "mistral"):
        self.agent = Agent(
            ...
            "Your task is to select the single best dataset for training a Medical Visual Question Answering (Medical VQA) model.",
            "Selection criteria in order of priority: (1) imaging modality match, (2) dataset quality and relevance, (3) dataset size.",
            "Use only the dataset candidates provided in the prompt.",
            "Do not execute code.",
            "Do not use Python tools.",
            "Do not call any external tools or functions.",
